      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:space-x-12">
          ...
          <div className="lg:w-1/3 mb-8 lg:mb-0 flex justify-center">
            <img src="/src/assets/photo.jpeg" alt="Professional Photo" className="w-64 h-64 rounded-full object-cover shadow-xl border-4 border-blue-200" />
          </div>

          {/* Right Section: Content */}
          <div className="lg:w-2/3 text-lg leading-relaxed">
            <p className="mb-6">
              As a <span className="font-semibold text-blue-700">PhD holder in English from Integral University, Lucknow</span>, I bring a rigorous academic background and a passion for education to the forefront. My doctoral research focused on <span className="font-semibold text-blue-700">[Academic Area]</span>, equipping me with advanced analytical and critical thinking skills.
            </p>
